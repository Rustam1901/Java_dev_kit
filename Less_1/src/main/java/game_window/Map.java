...
public class Map extends JPanel {
    ...
    private static int mode, fieldSizeX, fieldSizeY, winLen;
    private static int width, height, cellWidth, cellHeight;
    ...
    private void showMessageGameOver(Graphics g) {
        ...
        switch (gameStateType) {
            ...
            case STATE_WIN_AI -> g.drawString(MSG_WIN_AI, 20, getHeight() / 2 + 60);
            case STATE_WIN_HUMAN -> g.drawString(MSG_WIN_HUMAN, 70, getHeight() / 2 + 60);
            default -> throw new RuntimeException("Unexceptional gameOver state: " + gameStateType);
        }
        gameWork = false;
    }
